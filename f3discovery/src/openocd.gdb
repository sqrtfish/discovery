...
#monitor stm32f3x.tpiu config internal itm.txt uart off 8000000
monitor stm32f3x.tpiu configure -protocol uart -traceclk 8000000 -output itm.txt -formatter on
